...
bg_image = pygame.image.load("assets\images\background\background.webp").convert_alpha()
...
#load vicory image
victory_img = pygame.image.load("assets\images\icons\victory2.png").convert_alpha()
